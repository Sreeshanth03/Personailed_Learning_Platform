  ...
  />
      ...
      <div className="subjects-section">
        ...
        <div className="marquee-container">
          <div className="marquee-content">
            Programming Languages: Python, Java, C#, JavaScript & More
          </div>
        </div>
      </div>
      ...
      <div className="grades-section">
        ...
        <div className="grade-level">
          <h2 className="primary-school">Primary School (1 to 5)</h2>
        </div>
        <div className="grade-level">
          <h2 className="middle-school">Middle School (6 to 8)</h2>
        </div>
        <div className="grade-level">
          <h2 className="high-school">High School (9 to 12)</h2>
        </div>
        <div className="grade-level">
          <h2 className="adult-learning">13 to Jobs</h2>
        </div>
      </div>
